    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                en: "All of the above",
                correct: false,
                explanation: "“种豆南山下，草盛豆苗稀”是结果而非艰辛细节。只有“道狭草木长，夕露沾我衣”是艰苦的细节描写。",
                explanationPy: "zhòng dòu nán shān xià cǎo shèng dòu miáo xī shì jié guǒ ér fēi jiān xīn xì jié zhǐ yǒu dào xiá cǎo mù zhǎng xī lù zhān wǒ yī shì jiān kǔ de xì jié miáo xiě",
                explanationEn: "The bean planting line shows results, not hardship details. Only the narrow paths and dew line is a concrete hardship detail."
            }
        ]
    }
];
